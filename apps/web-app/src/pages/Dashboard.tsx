  ...
  return (
    <div className="flex-1 min-h-screen bg-linear-to-br from-blue-50 via-blue-100 to-blue-200 p-6 space-y-6">
      ...
      <div className="grid md:grid-cols-4 grid-cols-2 gap-6">
        ...
        <StatBox title="Active Crawls" value={summary.activeCrawls.toString()} />
        <StatBox title="Open Issues" value={summary.openIssues.toString()} />
        <StatBox title="Compliance Score" value={summary.complianceScore.toString()} />
      </div>
          ...
          <CardContent className="flex flex-col justify-between h-full p-6">
            <div>
              ...
              <p className="text-base mt-4 opacity-90">
                ...
                alternative text, insufficient color contrast, broken form labels
                that often go unnoticed during manual checks.
              </p>
            </div>
